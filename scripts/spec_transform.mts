/**
 * The two postprocessing steps `generate-types.mts` applies to the OpenAPI spec, kept separate from the
 * CLI so they can be unit tested and type-checked. Both are pure.
 */
