        ...
        describe('lastRun()', () => {
            test.each(['get', 'dataset', 'keyValueStore', 'requestQueue', 'log'] as const)(
                ...
                async (method) => {
                    ...
                    const endpointIdMap = {
                        get: 'last-run-get',
                        dataset: 'last-run-dataset',
                        keyValueStore: 'last-run-keyValueStore',
                        requestQueue: 'last-run-requestQueue',
                        log: 'last-run-log',
                    } as const;
                    validateRequest({
        ...
        describe('versions()', () => {
            test('list() works', async () => {
                ...
                validateRequest({
                    query: {},
                    params: { actorId },
                    endpointId: 'list-actor-versions',
                });
        ...
        describe('envVars()', () => {
            test('list() works', async () => {
                ...
                validateRequest({
                    query: {},
                    params: { actorId, versionNumber },
                    endpointId: 'list-actor-env-vars',
                });
            ...
            test('create() works', async () => {
                ...
                validateRequest({
                    ...
                    params: { actorId, versionNumber },
                    body: actorEnvVar,
                    endpointId: 'create-actor-env-var',
                });
        ...
        describe('envVar()', () => {
            ...
            test('update() works', async () => {
                ...
                validateRequest({
                    ...
                    body: envVar,
                    endpointId: 'update-actor-env-var',
                });
