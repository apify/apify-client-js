...
export interface WebhookDispatchWebhookSummary
    extends
        Omit<GeneratedWebhookDispatchWebhookSummary, keyof WebhookDispatchWebhookSummaryRePointed>,
...
export interface ActorCollectionListItem
    extends Omit<GeneratedActorShort, keyof ActorCollectionListItemRePointed>, ActorCollectionListItemRePointed {}
...
export interface UserProxy extends Omit<GeneratedProxy, keyof UserProxyRePointed>, UserProxyRePointed {}
...
export interface EffectivePlatformFeatures
    extends
        Omit<GeneratedEffectivePlatformFeatures, keyof EffectivePlatformFeaturesRePointed>,
