...
- [\_delete](WebhookDispatchClient.md#_delete)
- [\_get](WebhookDispatchClient.md#_get)
- [\_params](WebhookDispatchClient.md#_params)
- [\_subResourceOptions](WebhookDispatchClient.md#_subresourceoptions)
- [\_toSafeId](WebhookDispatchClient.md#_tosafeid)
- [\_update](WebhookDispatchClient.md#_update)
